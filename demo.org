...
Like the undirected case, a directed graph is uniquely determined by an =n x n= matrix with entries =1= (all graphs here are unweighted), but it need not be symmetric.
